...
export namespace Prisma {
  ...
  */
    ...
    model: {
      Filme: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.FilmeFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.FilmeAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type FilmeOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "description", ExtArgs["result"]["filme"]>
  ...
  export interface FilmeDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Filmes that matches the filter.
     * @param {FilmeFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const filme = await prisma.filme.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: FilmeFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Filme.
     * @param {FilmeAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const filme = await prisma.filme.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: FilmeAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface FilmeFieldRefs {
    ...
    readonly name: FieldRef<"Filme", 'String'>
    readonly description: FieldRef<"Filme", 'String'>
  }
   ...
   * Filme findRaw
   */
  export type FilmeFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
   ...
   * Filme aggregateRaw
   */
  export type FilmeAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type FilmeWhereInput = {
    ...
    name?: StringFilter<"Filme"> | string
    description?: StringFilter<"Filme"> | string
  }
  ...
  export type FilmeScalarWhereWithAggregatesInput = {
    ...
    name?: StringWithAggregatesFilter<"Filme"> | string
    description?: StringWithAggregatesFilter<"Filme"> | string
  }
